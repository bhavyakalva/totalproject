...
public class Testcases extends TestBase {
	...
	public void testcase001() throws InterruptedException {
		...
		act.moveToElement(search).click().sendKeys(datatable.getCellData("sheet1", "Veg name", 2)).doubleClick().build().perform();
	...
	public void testcase002() {
		String vegName = (datatable.getCellData("sheet1", "Veg name", 4));
